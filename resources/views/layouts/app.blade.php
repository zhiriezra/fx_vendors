...
<html lang="en">
  ...
  <head>
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="{{asset('dist/assets/images/favicon.png')}}" type="image/x-icon" />
...
<footer class="pc-footer">
  ...
  <div style="display: flex; flex-direction: row; align-items: center; justify-content: center; color:#fff" class="pt-4">
    <p>FarmEx. © <script type="text/javascript">document.write( new Date().getFullYear() );</script> <strong></strong>. All Rights Reserved. </p>
  </div>

 <!-- Required Js -->
<script src="{{ asset('dist/assets/js/plugins/jquery/jquery.min.js') }} "></script>
...
<script>preset_change("preset-1");</script>
    ...
    <script>
        ...
        window.addEventListener('show-end-modal', event => {
            $('#confirmationModal2').modal('show');
        })

        window.addEventListener('hide-end-modal', event => {
